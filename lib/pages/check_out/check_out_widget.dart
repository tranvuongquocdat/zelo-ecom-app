  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<OrderRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final checkOutOrderRecord = snapshot.data!;
                                                        ...
                                                        child: Stack(
                                                          ...
                                                          children: [
                                                            if (containerUsersRecord
                                                                ...
                                                                null)
                                                              FutureBuilder<
                                                                  ShippingAddressesRecord>(
                                                                future: ShippingAddressesRecord
                                                                    .getDocumentOnce(
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  final shippingOrderShippingAddressesRecord =
                                                                      snapshot
                                                                          .data!;
                                                                  ...
                                                                  return wrapWithModel(
                                                                    ...
                                                                    child:
                                                                        ShippingOrderWidget(
                                                                      title: shippingOrderShippingAddressesRecord
                                                                          .addressName,
                                                                      address:
                                                                          shippingOrderShippingAddressesRecord
                                                                              .address,
                                                                    ),
                                                                  );
                                                                },
                                                              ...
                                                              wrapWithModel(
                                                                ...
                                                                child:
                                                                  ...
                                                                  title: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'q65z9dgb' /* Add address */,
                                                                  ),
                                                                  body: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'soey72ow' /* You don't have an address you ... */,
                                                                  ),
                                                                  hasAction:
                                                                      true,
                                                                  actionButtonText:
                                                            ...
                                                            return ListView
                                                              ...
                                                              itemBuilder: (context,
                                                                ...
                                                                return OrderItemWidget(
                                                                  key: Key(
                                                                      'Keyn5i_${productIndex}_of_${product.length}'),
                                                                  product:
                                                                      productItem,
                                                                  orderDocument:
                                                                      checkOutOrderRecord,
                                                          ...
                                                          children: [
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  formatNumber(
                                                                    functions.sumCartPrices(checkOutOrderRecord
                                                                        .products
                                                                        .toList()),
                                                                    formatType:
                                                                        FormatType
                                                            ...
                                                            Text(
                                                              formatNumber(
                                                                (functions.sumCartPrices(checkOutOrderRecord
                                                                            .products
                                                                            .toList()) -
                                                                        ((functions.sumCartPrices(checkOutOrderRecord.products.toList()) * (_model.promoPercent!)) /
                                                                            100)) +
                                                                    (_model
                                                                        .tax!),
                                                                formatType:
                                  ...
                                  onPressed: () async {
                                    ...
                                    context.goNamed(
                                      ...
                                      extra: <String, dynamic>{
                                        'order': _model.updatedOrderFinal,
                                      },
                                    );
