                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => FFButtonWidget(
                              onPressed: !valueOrDefault<bool>(
                                      currentUserDocument?.pinCodeEnabled,
                                      false)
                                  ? null
                                  : () async {
                                      context.pushNamed('pinCodeSet');
