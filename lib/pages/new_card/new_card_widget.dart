                          ...
                          children: [
                            wrapWithModel(
                              ...
                              child: MoneyCardWidget(
                                ...
                                cardNumber: valueOrDefault<String>(
                                  _model.cardNumberTextController.text,
                                  '5467 8786 9987 0073',
                                ),
                                balance: 0.0,
                                showTopUp: false,
                                expireDate: valueOrDefault<String>(
                                  _model.expireTextController.text,
                                  '-- --',
                                ),
                        ...
                        onPressed: () async {
                          ...
                          await CardsRecord.collection
                              ...
                              .set(createCardsRecordData(
                                ...
                                cardNumber:
                                    _model.cardNumberTextController.text,
                                expire: _model.expireTextController.text,
                                cvv: _model.cvvTextController.text,
                              ));
                          context.safePop();
                        },
